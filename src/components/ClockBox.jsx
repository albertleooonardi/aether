  ...
  return (
    <div className={`flex flex-col justify-between rounded-3xl glass p-5 ${className}`}>
      <div className="flex items-center justify-between">
        ...
        <span className="flex items-center gap-1.5 rounded-full glass-soft px-2.5 py-1 text-[11px] text-ink/80">
      ...
      <div className="my-3">
        <div className="text-4xl font-bold leading-none text-ink text-glow">{time}</div>
        <div className="mt-1.5 text-xs text-ink/60">{date}</div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="flex items-center gap-2 rounded-2xl glass-soft p-2.5">
          ...
          <div className="min-w-0">
            <div className="text-[10px] text-ink/55">Sunrise</div>
            <div className="truncate text-xs font-semibold text-ink">{weather.sunrise || '—'}</div>
          </div>
        </div>
        <div className="flex items-center gap-2 rounded-2xl glass-soft p-2.5">
          <Sunset size={16} className="shrink-0 text-orange-200" />
          <div className="min-w-0">
            <div className="text-[10px] text-ink/55">Sunset</div>
            <div className="truncate text-xs font-semibold text-ink">{weather.sunset || '—'}</div>
          </div>
        </div>
      </div>
    </div>
